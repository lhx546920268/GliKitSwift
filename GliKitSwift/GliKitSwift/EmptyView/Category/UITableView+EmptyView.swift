...
public extension UITableView {
    ...
    @objc private func gkEmpty_reloadSections(_ sections: IndexSet, with animation: UITableView.RowAnimation){
        gkEmpty_reloadSections(sections, with: animation)
        layoutEmtpyView()
    }
    
    @objc private func gkEmpty_insertRows(at indexPaths: [IndexPath], with animation: UITableView.RowAnimation){
        gkEmpty_insertRows(at: indexPaths, with: animation)
        layoutEmtpyView()
    }
    
    @objc private func gkEmpty_insertSections(_ sections: IndexSet, with animation: UITableView.RowAnimation){
        gkEmpty_insertSections(sections, with: animation)
        layoutEmtpyView()
    }
    
    @objc private func gkEmpty_deleteRows(at indexPaths: [IndexPath], with animation: UITableView.RowAnimation){
        gkEmpty_deleteRows(at: indexPaths, with: animation)
        layoutEmtpyView()
    }
    
    @objc private func gkEmpty_deleteSections(_ sections: IndexSet, with animation: UITableView.RowAnimation){
        gkEmpty_deleteSections(sections, with: animation)
        layoutEmtpyView()
    }
}
